...
<head>
  ...
  <title>Specific Users Under A Reseller Migration Tool</title>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .background {
      ...
      padding: 2rem;
      background: linear-gradient(to bottom, #ffffff, #ff6c2c);
    }
    form {
    ...
    button {
      ...
      background: #ff6c2c; color: #fff; border: none;
      padding: .75rem 1.5rem; border-radius: 4px; cursor: pointer;
    }
    button:hover { background: #e55b1e; }
    #output-container {
      width: 100%; max-width: 520px; margin-top: 2rem; padding: 1rem;
  ...
  <script>
    function startMigration() {
      ...
      out.textContent = '⏳ Starting migration…\n';
      const fd = new FormData(document.getElementById('migrationForm'));
      fetch('migrate.php',{method:'POST',body:fd,credentials:'same-origin'})
...
<body>
  <div class="background">
    <form id="migrationForm" onsubmit="event.preventDefault(); startMigration();">
      <h2>Specific Users Under A Reseller Migration Tool</h2>
      ...
      <label>Accounts to Migrate:
        <textarea name="accounts_list" required placeholder="acct1,acct2,acct3"></textarea>
      </label>
